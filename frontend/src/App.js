...
//     // Send POST request to Django's login endpoint
//     client
//       .post('/login/', {
//         username: email,
//         password: password,
...
// import Profils from './pages/Profile';
// import Info from './pages/Info';
// import { FaHome, FaSearch, FaUser, FaSignOutAlt, FaSignInAlt } from 'react-icons/fa';
// import axios from 'axios';
...
// function App() {
//   const [currentUser, setCurrentUser] = useState(null); // Holds user details or null
//   const [email, setEmail] = useState('');
...
//   function validateFields() {
//     if (!email || !password || (!username && window.location.pathname === '/register')) {
//       setErrorMessage('Visi lauki ir jāaizpilda!'); // "All fields are required!"
//       return false;
//     }
//     setErrorMessage('');
...
//         headers: {
//           'X-CSRFToken': csrfToken, // Attach CSRF token here
//         },
//       })
//       .then(response => {
//         setCurrentUser(response.data); // Assume response contains user data
//         navigate('/'); // Redirect to Home
//       })
//       .catch(() => setErrorMessage('Pieteikšanās neizdevās. Lūdzu pārbaudiet savus datus.'));
//   }
...
//       .then(() => {
//         alert('Reģistrācija veiksmīga! Tagad varat pieteikties.');
//         navigate('/login');
//       })
//       .catch(error => {
//         const errorMsg = error.response?.data?.error || 'Reģistrācija neizdevās.';
...
//       .post('/logout/', {}, {
//         headers: {
//           'X-CSRFToken': csrfToken,  // Attach the CSRF token to the headers
//         },
//       })
//       .then(() => {
//         setCurrentUser(null);
//         navigate('/login');
//       })
//       .catch(() => setErrorMessage('Atslēgšanās neizdevās.'));
//   }
...
//         <Container>
//           <Navbar.Brand>
//             <a href="https://www.karamuzejs.lv/" className="NavText">
//               Latviešu karavīri
//             </a>
//           </Navbar.Brand>
//           <Navbar.Collapse className="justify-content-end">
...
//                     </Link>
//                   </Button>
//                   <Button variant="outline-dark" onClick={handleLogout} className="ms-2 text-light">
//                     <FaSignOutAlt /> Atteikties
//                   </Button>
//                 </>
//               ) : (
...
//                       <FaSignInAlt className="icon-button" /> Pieteikties
//                     </Link>
//                   </Button>
//                   <Button variant="outline-dark" className="ms-2">
//                     <Link to="/register" className="text-decoration-none text-light">
//                       <FaUser className="icon-button" /> Reģistrēties
//                     </Link>
//                   </Button>
//                 </>
//               )}
...
//             element={
//               <Card className="w-50 p-4 shadow-lg rounded">
//                 <h4 className="text-center mb-4">Pieteikties</h4>
...
//             element={
//               <Card className="w-50 p-4 shadow-lg rounded">
//                 <h4 className="text-center mb-4">Reģistrēties</h4>
