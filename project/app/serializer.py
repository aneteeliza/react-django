...
#                   'dzimsanas_vieta', 'pedeja_dzives_vieta', 'mobilizesanas_datums_labots',
#                   'pirmā_dienesta_vieniba_labots', 'pirmā_dienesta_pakāpe', 'kritis_datums', 'info_par_krisanu',
#                   'pazudis_datums', 'info_par_pazusanu', 'miris_datums', 'info_par_mirsanu', 'dezertējis_datums',
#                   'apbalvots', 'paaugstinats_degradets', 'atbrīvots_no_dienesta_datums', 'atbrivosanas_iemesls',
#                   'ievainots', 'navessods_arests', 'cita_informacija']
